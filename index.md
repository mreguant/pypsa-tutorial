...
title: Home
nav_order: 1
description: "A teaching tool for power system modeling using PyPSA."
---

# PyPSA Teaching Tool
{: .fs-9 }

Welcome! This site is a structured guide to learning **Python Power System Analysis (PyPSA)**. 
{: .fs-6 .fw-300 }

[View on GitHub](https://github.com/mreguant/pypsa-tutorial){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 } 
